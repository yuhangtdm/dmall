 ...
 */
@Component
public class GetMemberInvoiceHandler extends AbstractCommonHandler<Long, MemberInvoiceDO, MemberInvoiceResponseDTO> {

    @Autowired
    private MemberInvoiceMapper memberInvoiceMapper;

    @Override
    public BaseResult<MemberInvoiceResponseDTO> processor(Long id) {
