 ...
 */
@Component
public class ResetPasswordUserHandler extends AbstractCommonHandler<Long, UserDO, Long> {
    ...
    public BaseResult<Long> processor(Long id) {
        ...
        userDO.setPassword(PasswordUtil.getPassword(userDO.getPhone(), Constants.PASSWORD));
