 ...
 */
@Component
public class ListUserPermissionHandler extends AbstractCommonHandler<ListUserPermissionRequestDTO, UserPermissionDO, CommonUserPermissionResponseDTO> {

    @Autowired
    private UserPermissionMapper userPermissionMapper;

    @Override
    public BaseResult<List<CommonUserPermissionResponseDTO>> validate(ListUserPermissionRequestDTO requestDTO) {
        return ResultUtil.success();
    }

    @Override
    public BaseResult<List<CommonUserPermissionResponseDTO>> processor(ListUserPermissionRequestDTO requestDTO) {
        return ResultUtil.success();
    }
