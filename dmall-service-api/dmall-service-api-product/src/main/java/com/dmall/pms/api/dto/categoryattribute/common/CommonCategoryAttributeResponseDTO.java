...
/**
 * @description: 分类属性表 商品分类和商品属性的中间公共响应实体
 * @author: created by hang.yu on 2019-12-19 20:57:17
 */
@Data
@Accessors(chain = true)
@ApiModel(value = "CommonCategoryAttributeResponseDTO", description = "分类属性表 商品分类和商品属性的中间公共响应实体")
public class CommonCategoryAttributeResponseDTO implements Serializable {
