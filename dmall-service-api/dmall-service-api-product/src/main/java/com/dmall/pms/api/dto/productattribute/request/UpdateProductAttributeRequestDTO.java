...
@ApiModel(value="UpdateProductAttributeRequestDTO", description="修改属性值请求实体")
public class UpdateProductAttributeRequestDTO extends CommonProductAttributeRequestDTO {
