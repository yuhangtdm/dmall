...
/**
 * @description: 分类品牌关系公共响应实体
 * @author: created by hang.yu on 2019-12-07 20:44:53
 */
@Data
@Accessors(chain = true)
@ApiModel(value="CommonCategoryBrandResponseDTO", description="分类品牌关系公共响应实体")
public class CommonCategoryBrandResponseDTO implements Serializable {
