...
/**
 * @description: 评论点赞数公共响应实体
 * @author: created by hang.yu on 2019-12-02 23:18:01
 */
@Data
@Accessors(chain = true)
@ApiModel(value="CommonCommentPraiseResponseDTO", description="评论点赞数公共响应实体")
public class CommonCommentPraiseResponseDTO implements Serializable {
