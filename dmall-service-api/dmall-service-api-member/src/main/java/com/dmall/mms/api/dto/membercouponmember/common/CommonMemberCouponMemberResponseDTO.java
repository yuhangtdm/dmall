...
/**
 * @description: 会员-优惠券公共响应实体
 * @author: created by hang.yu on 2019-12-01 22:56:08
 */
@Data
@Accessors(chain = true)
@ApiModel(value="CommonMemberCouponMemberResponseDTO", description="会员-优惠券公共响应实体")
public class CommonMemberCouponMemberResponseDTO implements Serializable {
