...
/**
 * @description: 会员收货地址列表请求实体
 * @author: created by hang.yu on 2019-12-02 23:04:18
 */
@Data
@Accessors(chain = true)
@ApiModel(value="ListMemberReceiveAddressRequestDTO", description="会员收货地址列表请求实体")
public class ListMemberReceiveAddressRequestDTO implements Serializable {
