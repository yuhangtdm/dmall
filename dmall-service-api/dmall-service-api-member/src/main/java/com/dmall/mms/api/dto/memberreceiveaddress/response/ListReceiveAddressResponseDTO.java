...
/**
 * @description: 会员地址列表响应实体
 * @author: created by hang.yu on 2020/2/29 15:29
 */
@Data
@Accessors(chain = true)
@ApiModel(value = "ListReceiveAddressResponseDTO", description = "会员地址列表响应实体")
public class ListReceiveAddressResponseDTO implements Serializable {
