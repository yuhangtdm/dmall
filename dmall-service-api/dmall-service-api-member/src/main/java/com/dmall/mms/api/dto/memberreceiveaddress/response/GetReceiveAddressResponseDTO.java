...
/**
 * @description: 单个会员地址响应实体
 * @author: created by hang.yu on 2020/2/29 15:29
 */
@Data
@Accessors(chain = true)
@ApiModel(value = "GetReceiveAddressResponseDTO", description = "单个会员地址响应实体")
public class GetReceiveAddressResponseDTO implements Serializable {
