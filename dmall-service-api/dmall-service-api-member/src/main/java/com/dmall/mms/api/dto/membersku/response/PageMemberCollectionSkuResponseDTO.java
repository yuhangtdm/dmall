package com.dmall.mms.api.dto.membersku.response;
...
@ApiModel(value = "PageMemberCollectionSkuResponseDTO", description = "会员收藏sku分页响应实体")
public class PageMemberCollectionSkuResponseDTO implements Serializable {
    ...
    @ApiModelProperty(value = "sku状态", position = 10)
