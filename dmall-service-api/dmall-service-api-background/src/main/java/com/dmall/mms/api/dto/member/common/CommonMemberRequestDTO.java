...
/**
 * @description: 会员公共请求实体
 * @author: created by hang.yu on 2020-02-22 23:31:53
 */
@Data
@Accessors(chain = true)
@ApiModel(value = "CommonMemberRequestDTO", description = "会员公共请求实体")
public class CommonMemberRequestDTO implements Serializable {
    ...
    @ApiModelProperty(value = "用户来源 1-注册;2-qq;3-微信", position = 16)
    private Integer sourceType;

    @ApiModelProperty(value = "积分", position = 17)
    private Integer integration;

    @ApiModelProperty(value = "等级", position = 18)
    private String growth;

    @ApiModelProperty(value = "历史积分", position = 19)
