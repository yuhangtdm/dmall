...
/**
 * @description: 会员统计信息公共响应实体
 * @author: created by hang.yu on 2020-02-22 23:31:54
 */
@Data
@Accessors(chain = true)
@ApiModel(value = "CommonMemberStatisticsInfoResponseDTO", description = "会员统计信息公共响应实体")
public class CommonMemberStatisticsInfoResponseDTO implements Serializable {
    ...
    @ApiModelProperty(value = "状态 Y-不可用;N-可用", position = 18)
