package com.dmall.bms.api.dto.userresource.common;
...
@ApiModel(value = "CommonUserResourceResponseDTO", description = "后台用户和权限关系表 除角色中定义的权限以外的加减资源，加权限是指用户比角色多出的权限，减权限是指用户比角色少的权限公共响应实体")
public class CommonUserResourceResponseDTO implements Serializable {
