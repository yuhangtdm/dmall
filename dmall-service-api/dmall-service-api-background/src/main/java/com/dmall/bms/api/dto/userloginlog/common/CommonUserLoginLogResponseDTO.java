...
/**
 * @description: 后台用户登录日志公共响应实体
 * @author: created by hang.yu on 2020-01-05 18:36:37
 */
@Data
@Accessors(chain = true)
@ApiModel(value = "CommonUserLoginLogResponseDTO", description = "后台用户登录日志公共响应实体")
public class CommonUserLoginLogResponseDTO implements Serializable {
