package com.dmall.bms.api.dto.resource.common;
...
@ApiModel(value = "CommonResourceResponseDTO", description = "资源公共响应实体")
public class CommonResourceResponseDTO implements Serializable {
