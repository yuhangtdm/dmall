...
/**
 * @description: 数据字典公共响应实体
 * @author: created by hang.yu on 2020-01-05 18:36:36
 */
@Data
@Accessors(chain = true)
@ApiModel(value = "CommonDataDictionaryResponseDTO", description = "数据字典公共响应实体")
public class CommonDataDictionaryResponseDTO implements Serializable {
