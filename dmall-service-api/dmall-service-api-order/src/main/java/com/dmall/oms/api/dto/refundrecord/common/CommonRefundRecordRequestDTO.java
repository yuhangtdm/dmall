...
/**
 * @description: 退款记录公共请求实体
 * @author: created by hang.yu on 2020-04-02 22:25:15
 */
@Data
@Accessors(chain = true)
@ApiModel(value = "CommonRefundRecordRequestDTO", description = "退款记录公共请求实体")
public class CommonRefundRecordRequestDTO implements Serializable {
