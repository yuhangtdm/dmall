...
public class OrderAddressRequestDTO implements Serializable {
    ...
    @ApiModelProperty(value = "收货人姓名", required = true, position = 2)
    ...
    @ApiModelProperty(value = "所在省", required = true, position = 4)
    @NotBlank(message = "收货人省份不能为空")
    private String province;

    @ApiModelProperty(value = "所在市", required = true, position = 5)
    @NotBlank(message = "收货人城市不能为空")
    private String city;

    @ApiModelProperty(value = "所在区/县", required = true, position = 6)
    @NotBlank(message = "收货人区/县不能为空")
    private String region;

    @ApiModelProperty(value = "详细地址", required = true, position = 7)
