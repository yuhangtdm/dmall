...
/**
 * @description: 子订单job表 分页请求实体
 * @author: created by hang.yu on 2020-04-18 21:31:26
 */
@Data
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = true)
@ApiModel(value = "PageSubOrderJobRequestDTO", description =  "子订单job表 分页请求实体")
public class PageSubOrderJobRequestDTO  extends PageRequestDTO {
