...
public class ApplyRefundRequestDTO implements Serializable {
    ...
    @ApiModelProperty(value = "服务单号", required = true, position = 1)
    ...
    @ApiModelProperty(value = "订单项编号", required = true, position = 2)
    ...
    @ApiModelProperty(value = "退款金额", required = true, position = 4)
    @NotBlank(message = "退款金额不能为空")
    private BigDecimal amount;

    @ApiModelProperty(value = "支付方式", required = true, position = 5)
    @NotNull(message = "支付方式不能为空")
    @ValueInEnum(PaymentTypeEnum.class)
    private Integer paymentType;

    @ApiModelProperty(value = "退款原因", required = true, position = 6)
    @NotBlank(message = "退款原因不能为空")
    private String refundReason;

    @ApiModelProperty(value = "skuId", required = true, position = 7)
    @NotNull(message = "skuId不能为空")
    private Long skuId;

    @ApiModelProperty(value = "sku名称", required = true, position = 8)
    @NotBlank(message = "sku名称不能为空")
    private String skuName;

    @ApiModelProperty(value = "sku数量", required = true, position = 9)
